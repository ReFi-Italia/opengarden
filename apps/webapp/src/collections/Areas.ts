...
const AREA_TYPE_OPTIONS = [
  ...
  { label: 'Institutional grounds', value: String(AreaType.InstitutionalGrounds) },
...
const freezeRegisteredAreaInputs: CollectionBeforeValidateHook = async ({
  ...
  const frozenFields = ['latitude', 'longitude', 'areaType', 'metadataHash'] as const
...
export const Areas: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      options: AREA_LIFECYCLE_STATUSES.map((value) => ({ label: value, value })),
      index: true,
    },
  ],
}
