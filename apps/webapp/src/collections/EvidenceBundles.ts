...
export const EvidenceBundles: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        readOnly: true,
        description: 'Captured at build so the bundle stays legible if the parent is renamed.',
      },
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'checkin', type: 'relationship', relationTo: 'gardenerCheckins' },
        { name: 'checkout', type: 'relationship', relationTo: 'gardenerCheckouts' },
    ...
    },
    {
      ...
      admin: {
        readOnly: true,
        description: 'Exact bytes uploaded to IPFS — preserved for re-verification.',
      },
    },
    {
      name: 'bundleVersion',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'healthcheckOrderValid', type: 'checkbox', defaultValue: false },
        { name: 'executionDateBracketed', type: 'checkbox', defaultValue: false },
    ...
    },
    {
      ...
      admin: {
        readOnly: true,
        description: 'Last validateFinalizeInput result; publish is disabled until empty.',
      },
    },
    {
      name: 'lastError',
      ...
      admin: {
        readOnly: true,
        description: 'Captured on any "failed" transition so the admin can inspect.',
      },
    },
  ],
}
